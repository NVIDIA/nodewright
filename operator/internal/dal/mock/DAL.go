...
func (_e *MockDAL_Expecter) GetDeploymentPolicies(ctx any, opts ...any) *MockDAL_GetDeploymentPolicies_Call {
...
//   - ctx context.Context
//   - name string
func (_e *MockDAL_Expecter) GetDeploymentPolicy(ctx any, name any) *MockDAL_GetDeploymentPolicy_Call {
...
//   - namespace string
//   - name string
func (_e *MockDAL_Expecter) GetJob(ctx any, namespace any, name any) *MockDAL_GetJob_Call {
...
//   - ctx context.Context
//   - opts ...client.ListOption
func (_e *MockDAL_Expecter) GetJobs(ctx any, opts ...any) *MockDAL_GetJobs_Call {
...
//   - ctx context.Context
//   - nodeName string
func (_e *MockDAL_Expecter) GetNode(ctx any, nodeName any) *MockDAL_GetNode_Call {
...
//   - ctx context.Context
//   - opts ...client.ListOption
func (_e *MockDAL_Expecter) GetNodes(ctx any, opts ...any) *MockDAL_GetNodes_Call {
...
//   - namespace string
//   - name string
func (_e *MockDAL_Expecter) GetPod(ctx any, namespace any, name any) *MockDAL_GetPod_Call {
...
//   - container string
//   - maxBytes int64
func (_e *MockDAL_Expecter) GetPodLogTail(ctx any, namespace any, pod any, container any, maxBytes any) *MockDAL_GetPodLogTail_Call {
...
//   - ctx context.Context
//   - opts ...client.ListOption
func (_e *MockDAL_Expecter) GetPods(ctx any, opts ...any) *MockDAL_GetPods_Call {
...
//   - name string
//   - opts ...client.ListOption
func (_e *MockDAL_Expecter) GetSkyhook(ctx any, name any, opts ...any) *MockDAL_GetSkyhook_Call {
...
//   - ctx context.Context
//   - opts ...client.ListOption
func (_e *MockDAL_Expecter) GetSkyhooks(ctx any, opts ...any) *MockDAL_GetSkyhooks_Call {
