...
func (_e *MockSkyhookNodes_Expecter) AddCompartment(name any, compartment any) *MockSkyhookNodes_AddCompartment_Call {
...
func (_e *MockSkyhookNodes_Expecter) AddCompartmentNode(name any, node any) *MockSkyhookNodes_AddCompartmentNode_Call {
...
//   - node wrapper.SkyhookNode
func (_e *MockSkyhookNodes_Expecter) AddNode(node any) *MockSkyhookNodes_AddNode_Call {
...
//   - node wrapper.SkyhookNode
func (_e *MockSkyhookNodes_Expecter) AssignNodeToCompartment(node any) *MockSkyhookNodes_AssignNodeToCompartment_Call {
...
//   - name string
func (_e *MockSkyhookNodes_Expecter) GetNode(name any) *MockSkyhookNodes_GetNode_Call {
...
//   - logger logr.Logger
func (_e *MockSkyhookNodes_Expecter) Migrate(logger any) *MockSkyhookNodes_Migrate_Call {
...
func (_e *MockSkyhookNodes_Expecter) SetStatus(status any) *MockSkyhookNodes_SetStatus_Call {
...
//   - logger logr.Logger
func (_e *MockSkyhookNodes_Expecter) UpdateCondition(logger any) *MockSkyhookNodes_UpdateCondition_Call {
...
type MockSkyhookNodes_UpdateDrainBlockedCondition_Call struct {
	*mock.Call
}
