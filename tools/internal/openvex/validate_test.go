...
const unboundStatement = `{"vulnerability": {"name": "CVE-2026-0001"},
	"products": [{"@id": "pkg:oci/operator", "identifiers": {"purl": "pkg:oci/operator"}, "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}],
...
const boundStatement = `{"vulnerability": {"name": "CVE-2026-0001"},
	...
	"subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}],
	"status": "not_affected", "justification": "component_not_present"}`
...
An empty array asserts that there are no exceptions to declare; it does not assert the images are clean. If this case now fails, someone restored the sibling's rule, which gates every NodeWright release on having a statement to write.`,
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}], "status": "not_affected",
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}],
				"status": "fixed"}`),
			wantErr:     true,
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"identifiers": {"cpe23": "cpe:2.3:a:nvidia:operator"}, "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}],
				"status": "fixed"}`),
			wantErr:     true,
		...
		{
			name: "a product with no subcomponents is rejected",
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator"}], "status": "not_affected",
				"justification": "component_not_present"}`),
			wantErr:     true,
			wantMessage: "no subcomponents",
			note:        "a statement naming only the image asserts the whole image is unaffected, which is never what the assessment was about",
		},
		{
			name: "a subcomponent without a version is rejected",
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator",
				"subcomponents": [{"@id": "pkg:pypi/pillow"}]}], "status": "not_affected",
				"justification": "component_not_present"}`),
			wantErr:     true,
			wantMessage: "without a version",
			note:        "a version-less subcomponent keeps suppressing after the package is upgraded, covering a version nobody assessed",
		},
		{
			name: "a version carried only inside a qualifier is not a version",
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator",
				"subcomponents": [{"@id": "pkg:pypi/pillow?vcs_url=git+https://x/y@abc"}]}],
				"status": "not_affected", "justification": "component_not_present"}`),
			wantErr:     true,
			wantMessage: "without a version",
			note:        "purl puts the version before the qualifiers, so an @ inside a qualifier value must not count as one",
		},
		{
			name: "a versioned subcomponent carrying qualifiers is accepted",
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator",
				"subcomponents": [{"@id": "pkg:deb/debian/libssl3t64@3.5.6-1~deb13u1?arch=arm64"}]}],
				"status": "not_affected", "justification": "component_not_present"}`),
		},
		{
			name: "a subcomponent identified by identifiers.purl is accepted",
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator",
				"subcomponents": [{"identifiers": {"purl": "pkg:pypi/pillow@12.2.0"}}]}],
				"status": "not_affected", "justification": "component_not_present"}`),
		},
		{
		...
		},
		{
			...
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator",
				"subcomponents": [{"@id": "pkg:golang/stdlib@go1.27.1"}]}],
				"status": "fixed"}`),
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}], "status": "probably_fine"}`),
			wantErr:     true,
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}]}`),
			wantErr:     true,
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}], "status": "fixed",
				"justification": "we looked and it seemed fine"}`),
			wantErr:     true,
			wantMessage: "is not one of component_not_present",
		...
		},
		{
			...
			mode: "source",
			document: vexDocument("", `{"vulnerability": {"name": "CVE-2026-0001"},
				"products": [{"@id": "pkg:oci/operator", "subcomponents": [{"@id": "pkg:golang/example.com/mod@v1.2.3"}]}], "status": "affected"}`),
			wantErr:     true,
